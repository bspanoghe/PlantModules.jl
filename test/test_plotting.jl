@test PlantModules.plotgraph(sol, plantstructure, PlantModules.getnodes(plantstructure)[1]) isa Vector{AbstractPlot}
@test PlantModules.plotgraph(sol, plantstructure, PlantModules.getnodes(plantstructure)[5], varname = :N) isa AbstractPlot
